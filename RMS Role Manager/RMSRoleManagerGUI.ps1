...
- Updated: Added 'Console Dashboards' category and populated 'Active Directory Cleanup Tool' & 'Hardware/Firmware Audit'
- Updated: Populated 'Content Distribution Monitor' permissions

Author: Chris Antoku
Updated: Added Content Distribution Monitor permissions
#>
...
$Global:RmsToolMap = @(
    ...
    # ========================== CONSOLE DASHBOARDS ==========================
    # Active Directory Cleanup Tool (Permissions Set)
    [pscustomobject]@{ Cat="Console Dashboards"; Name="Active Directory Cleanup Tool (Coming Soon)"; Plugin="ActiveDirectory"; Action="AddAccountToGroup" },
    [pscustomobject]@{ Cat="Console Dashboards"; Name="Active Directory Cleanup Tool (Coming Soon)"; Plugin="ActiveDirectory"; Action="RemoveAccountFromGroup" },
    [pscustomobject]@{ Cat="Console Dashboards"; Name="Active Directory Cleanup Tool (Coming Soon)"; Plugin="LocalActions"; Action="ActiveDirectoryCleanupTool" },
    
    # Hardware and Firmware Audit (Permissions Set)
    ...
    # Content Distribution Monitor (Permissions Set)
    ...
    [pscustomobject]@{ Cat="Console Dashboards"; Name="BitLocker Compliance (Coming Soon)"; Plugin="TBD_Plugin"; Action="TBD_Action" },
    [pscustomobject]@{ Cat="Console Dashboards"; Name="LAPS Dashboard (Coming Soon)"; Plugin="TBD_Plugin"; Action="TBD_Action" },
    [pscustomobject]@{ Cat="Console Dashboards"; Name="Software Updates Deployment Status (Coming Soon)"; Plugin="TBD_Plugin"; Action="TBD_Action" }
)
